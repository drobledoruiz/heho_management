################################################################################
##         Function to find the ideal n pairs (those with lowest MSI)         ##
##                                                                            ##
...
##   Line 99: Main function find.ideal.pairs                                  ##
##   Line 146: Example of use for find.ideal.pairs (with recommended           ##
##             pre-treatment)                                                 ##
################################################################################
...
#################### Defining main function FIND IDEAL PAIRS ####################
find.ideal.pairs <- function(df, n, max.pairs.male, max.pairs.female) {
  
  df <- df[order(df$kinship), ]  # Sort dataframe by kinship (lowest first)
  ...
  ##### Final dataframe with ideal pairs
  return(sel)
}
################################################################################
